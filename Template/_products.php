...
<section id="product" class="py-3">
        <div class="container">
            <div class="row">
                <div class="col-sm-6">
                    <img src="<?php  echo $item['item_image'] ?? "./assets/products/1.png"; ?>" alt="Image1" class="img-fluid">
                ...
                <div class="col-sm-6 py-5">
                    ...
                    <div class="d-flex">
                        ...
                        <a href="#" class="px-2 font-rale font-size-14">2036 ratings | 100+ answered questions</a>
                    </div>
                    <hr class="m-0">
                    ...
                    <div id="order-details" class="font-rale d-flex flex-column text-dark">
                        <small>Delivery by: July 02 - July 12</small>
                        <small>Sold by: <a href="#">Daily Electronics</a>(4.5 out of 5 | 185 ratings)</small>
                        <small><i class="fas fa-map-marker-alt color-primary"></i>&nbsp;&nbsp;Deliver to Costumer - 4242401</small>
                    </div>
                    <!--/order details-->
